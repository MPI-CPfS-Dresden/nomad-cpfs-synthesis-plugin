...
Includes ELN entries for Flux Growth, Czochalski, Bridgman, Float zone, and CVT
...
```sh
git clone https://github.com/MPI-CPfS-Dresden/cpfs_synthesis.git
cd cpfs_synthesis
...
```sh
pip install dist/cpfs_synthesis-0.1.0
```
